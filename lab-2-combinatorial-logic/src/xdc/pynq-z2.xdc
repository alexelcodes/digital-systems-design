## PYNQ-Z2 board constraints file (general)
## Uncomment only the ports used in your design.
## All unused resources are kept commented for reference.
## IOSTANDARD is LVCMOS33 for all user I/O.
